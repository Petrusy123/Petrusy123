local cimguimodule = getWorkingDirectory() .. [[\lib\upmimgui\cimguidx9]]
local ffi = require "ffi"
local cdecl = assert(require "upmimgui.cdefs", "imgui.lua not properly build")
...
function ImTextureRef.__new(ctype,a1) -- generic version
    ...
    if (ffi.istype('uint32_t',a1) or type(a1)=='number') then return ImTextureRef.ImTextureRef_TextureID(a1) end
    print(ctype,a1)
...
function M.CheckboxFlags(a1,a2,a3) -- generic version
    ...
    if ffi.typeof('int32_t*') == ffi.typeof(a2) or ffi.typeof('const int32_t*') == ffi.typeof(a2) or ffi.typeof('int32_t[?]') == ffi.typeof(a2) or ffi.typeof('const int32_t[?]') == ffi.typeof(a2) then return M.CheckboxFlags_S64Ptr(a1,a2,a3) end
    if ffi.typeof('uint32_t*') == ffi.typeof(a2) or ffi.typeof('const uint32_t*') == ffi.typeof(a2) or ffi.typeof('uint32_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint32_t[?]') == ffi.typeof(a2) then return M.CheckboxFlags_U64Ptr(a1,a2,a3) end
    print(a1,a2,a3)
...
function M.ImIsPowerOfTwo(a1) -- generic version
    ...
    if (ffi.istype('uint32_t',a1) or type(a1)=='number') then return M.ImIsPowerOfTwo_U64(a1) end
    print(a1)
